import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, computed, defineComponent, provide, createElementBlock, defineAsyncComponent, h, unref, shallowReactive, Suspense, nextTick, Transition, mergeProps, useSSRContext, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, withCtx, markRaw, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch$1, w as withQuery, C as hasProtocol, k as parseURL, D as isScriptProtocol, E as joinURL, i as createError$1, F as defuFn, G as klona, f as defu, H as sanitizeStatusCode, I as createDefu, J as createHooks, K as isSamePath, L as toRouteMatcher, M as createRouter$1 } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./app-BAnnO4Br.mjs').then((m) => m.default || m)
  },
  {
    name: "assistants",
    path: "/assistants",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-Bt2rm73L.mjs').then((m) => m.default || m)
  },
  {
    name: "exams-id-grading",
    path: "/exams/:id()/grading",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./grading-BsaoSQcF.mjs').then((m) => m.default || m)
  },
  {
    name: "exams-id",
    path: "/exams/:id()",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CXuTT-Xo.mjs').then((m) => m.default || m)
  },
  {
    name: "exams-id-results",
    path: "/exams/:id()/results",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./results-DnVLyCyE.mjs').then((m) => m.default || m)
  },
  {
    name: "exams-new",
    path: "/exams/new",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./new-UIRIHSeu.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-BilX5_fG.mjs').then((m) => m.default || m)
  },
  {
    name: "threads-id",
    path: "/threads/:id()",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-CrfzQIFA.mjs').then((m) => m.default || m)
  }
];
...
const session_server_vHm08iceVX = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-DfRtqKOF.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-Bmtji0Nk.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: () => import('./default-D4kUxvCc.mjs').then((m) => m.default || m),
  public: () => import('./public-BRLx20dw.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-4Mx_F9fK.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-GktO8ALy.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useUserSession as a, useRoute as b, appConfig as c, __nuxt_component_0 as d, entry$1 as default, useAppConfig as e, useNuxtApp as f, asyncDataDefaults as g, createError as h, fetchDefaults as i, useRequestFetch as j, useRouter as k, looseToNumber as l, mergeConfig as m, navigateTo as n, nuxtLinkDefaults as o, useRuntimeConfig as p, useState as q, useHead as u };
