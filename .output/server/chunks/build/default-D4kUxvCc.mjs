...
import { _ as __nuxt_component_2$1 } from './Icon-CfnVCWfk.mjs';
...
import { m as mergeConfig, c as appConfig, a as useUserSession, n as navigateTo, _ as _export_sfc } from './server.mjs';
...
import { A as A$3, o as o$1$1, I as I$1, l as l$2, i as i$5, u as u$7, N as N$4, t as t$4, s as s$1$1, d as s, S as S$1, T as T$2, a as l$1$1, c as useId, b as o$2 } from './keyboard-CeiOvDLO.mjs';
import { f as defu } from '../runtime.mjs';
import { g as getNuxtLinkProps, u as useInjectButtonGroup, a as __nuxt_component_0$1, c as getULinkProps, _ as __nuxt_component_3$3 } from './Button-CHDquoFg.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    `https://buy.stripe.com/test_6oE16faCzeD20EM6oo?prefilled_email=${encodeURIComponent((_a = user.value) == null ? void 0 : _a.email)}`;
    function handleShowPurchaseModal() {
      isOpen.value = true;
    }
    async function handleBuy() {
      const data = await $fetch("/api/stripe", {
        body: JSON.stringify({ amount: 5, domain: (void 0).location.href }),
        method: "POST"
      });
      (void 0).location = data;
    }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: threads, refresh: refreshThreads } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/threads", "$i9bCpVDU6M")), __temp = await __temp, __restore(), __temp);
    const { loggedIn } = useUserSession();
    if (!loggedIn.value) {
      [__temp, __restore] = withAsyncContext(() => navigateTo("/")), await __temp, __restore();
    }
    const { data: user, refresh: refreshUserData } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/user", "$EkOtDekJM5")), __temp = await __temp, __restore(), __temp);
    useIntervalFn(() => {
      refreshUserData();
    ...
    const links = computed(() => {
      var _a2;
      var _a;
      return (_a = (_a2 = threads.value) != null ? _a2 : []) == null ? void 0 : _a.map((thread) => {
        var _a3;
        return {
          label: (_a3 = thread.summary) != null ? _a3 : `${new Date(thread.created_at * 1e3).toTimeString()} - id ${thread.id}`,
    ...
    const examLinks = computed(
      () => {
        var _a;
        return ((_a = exams.value) != null ? _a : []).map((exam) => {
          return {
            label: exam.summary,
    ...
    const credit = computed(() => {
      var _a, _b;
      if (!((_a = user.value) == null ? void 0 : _a.credit)) {
        return;
      }
...
//# sourceMappingURL=default-D4kUxvCc.mjs.map
