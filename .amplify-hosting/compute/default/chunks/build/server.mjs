import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineComponent, provide, createElementBlock, defineAsyncComponent, readonly, h, computed, unref, shallowReactive, Suspense, nextTick, Transition, mergeProps, useSSRContext, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, withCtx, markRaw, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch$1, C as withQuery, D as hasProtocol, F as parseURL, G as isScriptProtocol, H as joinURL, l as createError$1, I as defuFn, J as klona, a as defu, K as sanitizeStatusCode, L as createDefu, M as createHooks, N as appendHeader, O as isSamePath, P as getRequestHeaders, s as sendRedirect, Q as getHeader, R as toRouteMatcher, S as createRouter$1 } from '../../index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./app-D85Odevs.mjs').then((m) => m.default || m)
  },
  {
    name: "assistants",
    path: "/assistants",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CktgpUBy.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./grading-BjEtopgk.mjs').then((m) => m.default || m)
  },
  {
    name: "exams-id",
    path: "/exams/:id()",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BmnN1X-r.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./results-H6eS1EAA.mjs').then((m) => m.default || m)
  },
  {
    name: "exams-new",
    path: "/exams/new",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./new-0Mn8SlDQ.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-i0KzIG4x.mjs').then((m) => m.default || m)
  },
  {
    name: "threads-id",
    path: "/threads/:id()",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-CoxbJy5t.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-COXSlKhV.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-DIZ_xa7t.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: () => import('./default-BCMWp88Z.mjs').then((m) => m.default || m),
  public: () => import('./public-DUGKMa7w.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-NtXLoJfX.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-F6vKrz2I.mjs').then((r) => r.default || r));
