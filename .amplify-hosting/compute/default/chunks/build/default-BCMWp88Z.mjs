import { _ as __nuxt_component_0$3 } from './Container-ByzDIknU.mjs';
import { _ as __nuxt_component_0$2 } from './nuxt-link-DPBnjplD.mjs';
import { _ as __nuxt_component_2$1 } from './Icon-BTndY_Cj.mjs';
import { defineComponent, ref, computed, onMounted, onUnmounted, h as h$1, Fragment, watchEffect, watch, provide, unref, inject, getCurrentInstance, Teleport, reactive, nextTick, normalizeClass, toRef, useSSRContext, withAsyncContext, mergeProps, withCtx, createTextVNode, renderSlot, createVNode, openBlock, createBlock, toDisplayString, createCommentVNode, isRef, shallowRef, resolveDynamicComponent, resolveComponent, renderList, Transition } from 'vue';
import { twMerge, twJoin } from 'tailwind-merge';
import { u as useUI, a as arrow$1 } from './selectMenu-CW6COth7.mjs';
import { m as mergeConfig, c as appConfig, a as useAuth, n as navigateTo, _ as _export_sfc } from './server.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderSlot, ssrRenderAttrs, ssrRenderVNode, ssrRenderClass, ssrRenderList, ssrIncludeBooleanAttr, ssrRenderStyle } from 'vue/server-renderer';
import { A as A$3, o as o$1$1, I as I$1, l as l$2, i as i$5, u as u$7, N as N$4, t as t$4, s as s$1$1, d as s, S as S$1, T as T$2, a as l$1$1, c as useId, b as o$2 } from './keyboard-CNNi71PZ.mjs';
import { a as defu } from '../../index.mjs';
import { g as getNuxtLinkProps, u as useInjectButtonGroup, a as __nuxt_component_0$1, c as getULinkProps, _ as __nuxt_component_3$3 } from './Button-C9mGLMtE.mjs';
...
function _(e2) {
  let r2 = i$3(e2);
  nextTick(() => {
    r2 && !w$4(r2.activeElement, 0) && S(e2);
  });
}
...
function w$2(f2, m2, l2 = computed(() => true)) {
  function a2(e2, r2) {
    ...
    for (let o2 of c2) {
      if (o2 === null)
        continue;
      let n2 = o2 instanceof HTMLElement ? o2 : o$1$1(o2);
...
let ue = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(t2, { attrs: n$12, slots: r2, expose: l2 }) {
  ...
  function H2(u2) {
    ...
    d2 instanceof HTMLElement && d2.dataset.headlessuiFocusGuard !== "true" && (N$2(T2, d2) || (s3.value ? P(o$1$1(o2), u$7(f2.value, { [d$3.Forwards]: () => N$3.Next, [d$3.Backwards]: () => N$3.Previous }) | N$3.WrapAround, { relativeTo: u2.target }) : u2.target instanceof HTMLElement && S(u2.target)));
  }
  return () => {
  ...
  return onMounted(() => i2.value = true), onUnmounted(() => i2.value = false), onMounted(() => {
    watch([n2, r2, l2], (e2, m2) => {
      ...
      f2 && t$3(() => {
        ...
        if (!i2.value)
          return;
        let a2 = o$1$1(r2), s3 = (F2 = t2.value) == null ? void 0 : F2.activeElement;
        if (a2) {
          if (a2 === s3) {
            o2.value = s3;
            return;
...
let A$1 = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Ye = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: A$1 }, initialFocus: { type: Object, default: null }, id: { type: String, default: null }, role: { type: String, default: "dialog" } }, emits: { close: (t2) => true }, setup(t2, { emit: i2, attrs: l2, slots: p2, expose: s$12 }) {
  ...
  })] }), ee2 = computed(() => w2.value ? "parent" : "leaf"), U2 = computed(() => S2 !== null ? (S2.value & i$5.Closing) === i$5.Closing : false), te2 = computed(() => N2 || U2.value ? false : k$1.value), le = computed(() => {
    var e2, a2, d2;
    return (d2 = Array.from((a2 = (e2 = E$22.value) == null ? void 0 : e2.querySelectorAll("body > *")) != null ? a2 : []).find((f2) => f2.id === "headlessui-portal-root" ? false : f2.contains(o$1$1(K)) && f2 instanceof HTMLElement)) != null ? d2 : null;
  });
  E(le, te2);
  let ae = computed(() => w2.value ? true : k$1.value), oe = computed(() => {
    var e2, a2, d2;
    return (d2 = Array.from((a2 = (e2 = E$22.value) == null ? void 0 : e2.querySelectorAll("[data-headlessui-portal]")) != null ? a2 : []).find((f2) => f2.contains(o$1$1(K)) && f2 instanceof HTMLElement)) != null ? d2 : null;
  });
...
let ge$1 = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(o2, { slots: M2, attrs: i2 }) {
  ...
  function b(t2 = (a2) => a2) {
    let a2 = d2.value !== null ? r2.value[d2.value] : null, n2 = O$1(t2(r2.value.slice()), (v2) => o$1$1(v2.dataRef.domRef)), s3 = a2 ? n2.indexOf(a2) : null;
  ...
  let l2 = { menuState: I2, buttonRef: p2, itemsRef: e2, items: r2, searchQuery: f2, activeItemIndex: d2, activationTrigger: g2, closeMenu: () => {
    ...
    let s3 = b(), v2 = f$1(t2 === c$1.Specific ? { focus: c$1.Specific, id: a2 } : { focus: t2 }, { resolveItems: () => s3.items, resolveActiveIndex: () => s3.activeItemIndex, resolveId: (u2) => u2.id, resolveDisabled: (u2) => u2.dataRef.disabled });
    ...
    let n2 = b((s3) => [...s3, { id: t2, dataRef: a2 }]);
  ...
  return w$2([p2, e2], (t2, a2) => {
    var n2;
    l2.closeMenu(), w$4(a2, h.Loose) || (t2.preventDefault(), (n2 = o$1$1(p2)) == null || n2.focus());
  }, computed(() => I2.value === 0)), provide(A, l2), t$4(computed(() => u$7(I2.value, { [0]: i$5.Open, [1]: i$5.Closed }))), () => {
  ...
  var b;
  let p2 = (b = o2.id) != null ? b : `headlessui-menu-button-${I$1()}`, e2 = O("MenuButton");
    ...
    switch (l2.key) {
      ...
      case o$2.ArrowDown:
        l2.preventDefault(), l2.stopPropagation(), e2.openMenu(), nextTick(() => {
          var t2;
          (t2 = o$1$1(e2.itemsRef)) == null || t2.focus({ preventScroll: true }), e2.goToItem(c$1.First);
        });
        break;
      case o$2.ArrowUp:
        l2.preventDefault(), l2.stopPropagation(), e2.openMenu(), nextTick(() => {
          var t2;
          (t2 = o$1$1(e2.itemsRef)) == null || t2.focus({ preventScroll: true }), e2.goToItem(c$1.Last);
        });
        break;
    }
  }
  ...
  function d2(l2) {
    o2.disabled || (e2.menuState.value === 0 ? (e2.closeMenu(), nextTick(() => {
      var t2;
      return (t2 = o$1$1(e2.buttonRef)) == null ? void 0 : t2.focus({ preventScroll: true });
    })) : (l2.preventDefault(), e2.openMenu(), te(() => {
      var t2;
      return (t2 = o$1$1(e2.itemsRef)) == null ? void 0 : t2.focus({ preventScroll: true });
    })));
  }
  let g2 = s$1$1(computed(() => ({ as: o2.as, type: M2.type })), e2.buttonRef);
  return () => {
    var n2;
    let l2 = { open: e2.menuState.value === 0 }, { ...t2 } = o2, a2 = { ref: e2.buttonRef, id: p2, type: g2.value, "aria-haspopup": "menu", "aria-controls": (n2 = o$1$1(e2.itemsRef)) == null ? void 0 : n2.id, "aria-expanded": e2.menuState.value === 0, onKeydown: r2, onKeyup: f2, onClick: d2 };
  ...
  I2({ el: e2.itemsRef, $el: e2.itemsRef }), i$1({ container: computed(() => o$1$1(e2.itemsRef)), enabled: computed(() => e2.menuState.value === 0), accept(t2) {
    ...
    switch (r2.value && clearTimeout(r2.value), t2.key) {
      ...
      case o$2.Enter:
        if (t2.preventDefault(), t2.stopPropagation(), e2.activeItemIndex.value !== null) {
          ...
          (a2 = o$1$1(s3.dataRef.domRef)) == null || a2.click();
        }
        e2.closeMenu(), _(o$1$1(e2.buttonRef));
        break;
      case o$2.ArrowDown:
      ...
      case o$2.Escape:
        t2.preventDefault(), t2.stopPropagation(), e2.closeMenu(), nextTick(() => {
          var n2;
          return (n2 = o$1$1(e2.buttonRef)) == null ? void 0 : n2.focus({ preventScroll: true });
        });
        break;
      case o$2.Tab:
        t2.preventDefault(), t2.stopPropagation(), e2.closeMenu(), nextTick(() => v(o$1$1(e2.buttonRef), t2.shiftKey ? N$3.Previous : N$3.Next));
        break;
      default:
  ...
  let g2 = l$2(), b = computed(() => g2 !== null ? (g2.value & i$5.Open) === i$5.Open : e2.menuState.value === 0);
  return () => {
    var s3, v2;
    let t2 = { open: e2.menuState.value === 0 }, { ...a2 } = o2, n2 = { "aria-activedescendant": e2.activeItemIndex.value === null || (s3 = e2.items.value[e2.activeItemIndex.value]) == null ? void 0 : s3.id, "aria-labelledby": (v2 = o$1$1(e2.buttonRef)) == null ? void 0 : v2.id, id: p2, onKeydown: f2, onKeyup: d2, role: "menu", tabIndex: 0, ref: e2.itemsRef };
    return A$3({ ourProps: n2, theirProps: a2, slot: t2, attrs: M2, slots: i2, features: N$4.RenderStrategy | N$4.Static, visible: b.value, name: "MenuItems" });
  };
  ...
  onMounted(() => e2.registerItem(p$1, g2)), onUnmounted(() => e2.unregisterItem(p$1)), watchEffect(() => {
    e2.menuState.value === 0 && f2.value && e2.activationTrigger.value !== 0 && nextTick(() => {
      var u2, h2;
      return (h2 = (u2 = o$1$1(r2)) == null ? void 0 : u2.scrollIntoView) == null ? void 0 : h2.call(u2, { block: "nearest" });
    });
  });
  function b(u2) {
    if (o2.disabled)
  ...
  return () => {
    ...
    return A$3({ ourProps: { id: p$1, ref: r2, role: "menuitem", tabIndex: u2 === true ? void 0 : -1, "aria-disabled": u2 === true ? true : void 0, onClick: b, onFocus: l2, onPointerenter: a2, onMouseenter: a2, onPointermove: n2, onMousemove: n2, onPointerleave: s3, onMouseleave: s3 }, theirProps: { ...i2, ...h2 }, slot: C, attrs: i2, slots: M2, name: "MenuItem" });
  };
} });
function l(r2) {
  let e2 = { called: false };
...
let W = N$4.RenderStrategy, he = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e2, { emit: t2, attrs: a2, slots: s3, expose: h2 }) {
  let n2 = ref(0);
  function r2() {
    n2.value |= i$5.Opening, t2("beforeEnter");
  }
  function l2() {
    n2.value &= ~i$5.Opening, t2("afterEnter");
  }
  function f2() {
    n2.value |= i$5.Closing, t2("beforeLeave");
  }
  function S2() {
    n2.value &= ~i$5.Closing, t2("afterLeave");
  }
  if (!me() && s())
  ...
  h2({ el: d2, $el: d2 });
  let { show: v2, appear: A2 } = Te(), { register: D, unregister: H2 } = ge(), i2 = ref(v2.value ? "visible" : "hidden"), I2 = { value: true }, c2 = I$1(), b = { value: false }, P2 = Q(() => {
  ...
  let j = g(e2.enter), M2 = g(e2.enterFrom), X = g(e2.enterTo), _2 = g(e2.entered), Y = g(e2.leave), Z2 = g(e2.leaveFrom), ee2 = g(e2.leaveTo);
  onMounted(() => {
    watchEffect(() => {
      if (i2.value === "visible") {
        let o2 = o$1$1(d2);
  ...
  function te2(o2) {
    let E2 = I2.value && !A2.value, p2 = o$1$1(d2);
    !p2 || !(p2 instanceof HTMLElement) || E2 || (b.value = true, v2.value && r2(), v2.value || f2(), o2(v2.value ? L$1(p2, j, M2, X, _2, (V) => {
  ...
  }), provide(N, P2), t$4(computed(() => u$7(i2.value, { ["visible"]: i$5.Open, ["hidden"]: i$5.Closed }) | n2.value)), () => {
    let { appear: o2, show: E2, enter: p2, enterFrom: V, enterTo: Ce, entered: ye, leave: be2, leaveFrom: Ee, leaveTo: Ve, ...U2 } = e2, ne = { ref: d2 }, re = { ...U2, ...A2.value && v2.value && c$3.isServer ? { class: normalizeClass([a2.class, U2.class, ...j, ...M2]) } : {} };
  ...
  let h2 = l$2(), n2 = computed(() => e2.show === null && h2 !== null ? (h2.value & i$5.Open) === i$5.Open : e2.show);
  watchEffect(() => {
...
const __nuxt_component_3$2 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$6]]);
...
const __nuxt_component_3$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$3]]);
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    `https://buy.stripe.com/test_6oE16faCzeD20EM6oo?prefilled_email=${encodeURIComponent((_b = (_a = data.value) == null ? void 0 : _a.user) == null ? void 0 : _b.email)}`;
    function handleShowPurchaseModal() {
      isOpen.value = true;
    }
    async function handleBuy() {
      const data2 = await $fetch("/api/stripe", {
        body: JSON.stringify({ amount: 5 }),
        method: "POST"
      });
      (void 0).location = data2;
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UDropdown = __nuxt_component_0;
      const _component_UButton = __nuxt_component_3$3;
      const _component_UModal = __nuxt_component_2;
      const _component_UCard = __nuxt_component_3$1;
      _push(`<!--[-->`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_UCard, {
              ...
              header: withCtx((_22, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h2${_scopeId2}>Purchase Study Credits</h2>`);
                } else {
                  return [
                    createVNode("h2", null, "Purchase Study Credits")
                  ];
                }
              }),
              ...
              default: withCtx((_22, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p${_scopeId2}><span class="font-mono"${_scopeId2}>StudyHQ</span> is not a &quot;pay as you go&quot; service. You pay for study credits, and use them as you message and generate exams. </p>`);
                  _push3(ssrRenderComponent(_component_UButton, { onClick: handleBuy }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Get $5`);
                      } else {
                        return [
                          createTextVNode("Get $5")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  return [
                    createVNode("p", null, [
                      ...
                      createTextVNode(' is not a "pay as you go" service. You pay for study credits, and use them as you message and generate exams. ')
                    ]),
                    createVNode(_component_UButton, { onClick: handleBuy }, {
                      default: withCtx(() => [
                        createTextVNode("Get $5")
                      ]),
                      _: 1
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SettingsMenu.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_UDivider = __nuxt_component_5;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { ctrl, n: n2 } = useMagicKeys();
    const { data: threads, refresh } = useFetch("/api/threads", "$i9bCpVDU6M");
    const { data } = useAuth();
    if (!((_a = data.value) == null ? void 0 : _a.user)) {
      [__temp, __restore] = withAsyncContext(() => navigateTo("/")), await __temp, __restore();
    }
    const { data: user, refresh: refreshUserData } = useFetch("/api/user", "$EkOtDekJM5");
    useIntervalFn(() => {
      refreshUserData();
    ...
    const links = computed(() => {
      var _a3;
      var _a2;
      return (_a2 = (_a3 = threads.value) != null ? _a3 : []) == null ? void 0 : _a2.map((thread) => {
        var _a4;
        return {
          label: (_a4 = thread.summary) != null ? _a4 : `${new Date(thread.created_at * 1e3).toTimeString()} - id ${thread.id}`,
          icon: "i-heroicons-document-solid",
          to: `/threads/${thread.id}`
        };
      });
    });
    const { data: exams, refresh: refreshExams } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/exams", "$5qyVLgIcY3")), __temp = await __temp, __restore(), __temp);
    const examLinks = computed(
      () => {
        var _a2;
        return ((_a2 = exams.value) != null ? _a2 : []).map((exam) => {
          return {
            label: exam.summary,
    ...
    const { run: handleNewThread, loading: creatingNewThread } = useLoading(
      async () => {
        const t2 = await $fetch("/api/threads", { method: "POST" });
        await navigateTo(`/threads/${t2.id}`);
      }
    );
    ...
    watchEffect(() => {
      if (ctrl.value && n2.value) {
        handleNewThread();
      }
    });
    const credit = computed(() => {
      var _a2, _b;
      if (!((_a2 = user.value) == null ? void 0 : _a2.credit)) {
        return;
      }
      const usd = ((_b = user == null ? void 0 : user.value) == null ? void 0 : _b.credit) / 100;
      return `$${usd.toFixed(2)}`;
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UContainer = __nuxt_component_0$3;
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_SettingsMenu = _sfc_main$4;
      const _component_UButton = __nuxt_component_3$3;
      const _component_UVerticalNavigation = __nuxt_component_4;
      const _component_UDivider = __nuxt_component_5;
      _push(ssrRenderComponent(_component_UContainer, mergeProps({ class: "pt-4" }, _attrs), {
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex justify-between items-center w-full mb-4 mx-2"${_scopeId}>`);
            ...
            if (unref(credit)) {
              _push2(`<span class="mr-4"${_scopeId}>${ssrInterpolate(unref(credit))}</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(ssrRenderComponent(_component_SettingsMenu, null, null, _parent2, _scopeId));
            _push2(`</div></div><div class="flex h-full"${_scopeId}><div class="w-72"${_scopeId}><div class="flex justify-between items-center"${_scopeId}><h2 class="font-bold m-2"${_scopeId}>Chats</h2>`);
            _push2(ssrRenderComponent(_component_UButton, {
              size: "xs",
              disabled: unref(creatingNewThread),
              loading: unref(creatingNewThread),
              onClick: unref(handleNewThread)
            }, {
              default: withCtx((_22, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` New Chat`);
            ...
            if (!unref(links).length) {
              _push2(`<div class="flex justify-center"${_scopeId}><p class="text-sm text-gray-500"${_scopeId}>No chats.</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(ssrRenderComponent(_component_UDivider, { class: "my-4" }, null, _parent2, _scopeId));
            _push2(`<div class="flex justify-between items-center"${_scopeId}><h2 class="font-bold m-2"${_scopeId}>Exams</h2>`);
            _push2(ssrRenderComponent(_component_UButton, {
              size: "xs",
            ...
            _push2(ssrRenderComponent(_component_UVerticalNavigation, {
              ...
              links: unref(examLinks)
            }, null, _parent2, _scopeId));
            if (!unref(examLinks).length) {
              _push2(`<div class="flex justify-center"${_scopeId}><p class="text-sm text-gray-500"${_scopeId}>No exams.</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="w-full h-full mb-4"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "flex justify-between items-center w-full mb-4 mx-2" }, [
                ...
                createVNode("div", { class: "flex items-center" }, [
                  unref(credit) ? (openBlock(), createBlock("span", {
                    key: 0,
                    class: "mr-4"
                  }, toDisplayString(unref(credit)), 1)) : createCommentVNode("", true),
                  createVNode(_component_SettingsMenu)
                ])
              ]),
              createVNode("div", { class: "flex h-full" }, [
                createVNode("div", { class: "w-72" }, [
                  createVNode("div", { class: "flex justify-between items-center" }, [
                    createVNode("h2", { class: "font-bold m-2" }, "Chats"),
                    createVNode(_component_UButton, {
                      size: "xs",
                      disabled: unref(creatingNewThread),
                      loading: unref(creatingNewThread),
                  ...
                  !unref(links).length ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: "flex justify-center"
                  }, [
                    createVNode("p", { class: "text-sm text-gray-500" }, "No chats.")
                  ])) : createCommentVNode("", true),
                  createVNode(_component_UDivider, { class: "my-4" }),
                  createVNode("div", { class: "flex justify-between items-center" }, [
                    createVNode("h2", { class: "font-bold m-2" }, "Exams"),
                    createVNode(_component_UButton, {
                      size: "xs",
                      onClick: handleNewExam
                    }, {
                  ...
                  !unref(examLinks).length ? (openBlock(), createBlock("div", {
                    key: 1,
                    class: "flex justify-center"
                  }, [
                    createVNode("p", { class: "text-sm text-gray-500" }, "No exams.")
                  ])) : createCommentVNode("", true)
                ]),
                createVNode("div", { class: "w-full h-full mb-4" }, [
...
//# sourceMappingURL=default-BCMWp88Z.mjs.map
